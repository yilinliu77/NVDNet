...
Point_set sample_points(const std::vector<Triangle_3>& v_mesh, const int v_num_points, bool at_least_one_point =false);
Point_set sample_points_according_density(const std::vector<Triangle_3>& v_mesh, const float v_num_points_per_m2);

Point_set sample_poisson_points(const std::vector<Triangle_3>& v_mesh, const int v_num_points, const int init_factor=5);
